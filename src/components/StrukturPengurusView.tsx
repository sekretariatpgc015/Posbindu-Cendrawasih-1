  ...
  const pengurusData: PengurusMember[] = [
    {
      ...
      role: 'Ketua',
      name: 'Dewi Tri P.',
      imageUrl: 'https://drive.google.com/thumbnail?id=1fCpYQeYeotor5ES2F4MIuKlLS9i-tJjl',
      category: 'inti',
    ...
    },
    {
      ...
      role: 'Sekretaris',
      name: 'Eny Suciati',
      imageUrl: 'https://drive.google.com/thumbnail?id=1uPf_oC31s-b3_gIIs2R6IWVhY0mbJ6JP',
      category: 'inti',
    ...
    },
    {
      ...
      role: 'Bendahara 1',
      name: 'Sumarni',
      imageUrl: 'https://drive.google.com/thumbnail?id=1ac8aqWGzgG0aZUd5I-OnKKK1rK8c3_g3',
      category: 'inti',
    ...
    },
    {
      ...
      role: 'Bendahara 2',
      name: 'Uun Yuningsih',
      imageUrl: 'https://drive.google.com/thumbnail?id=1sGlLXZ_Ua4S37Cz4gW1W398s_UrbK_3C',
      category: 'inti',
      color: 'border-amber-500 text-amber-700 bg-amber-50',
      badgeBg: 'bg-amber-500 text-white shadow-amber-100',
    },
    {
      ...
      role: 'Kader',
      name: 'Ernawati',
      imageUrl: 'https://drive.google.com/thumbnail?id=1SjHe3io-odF2UswZU4PbZlV50M_TLHnX',
      category: 'kader',
    ...
    },
    {
      ...
      role: 'Kader',
      name: 'Erni Suprapti',
      imageUrl: 'https://drive.google.com/thumbnail?id=1MhOPzYC4tlmMKnxKmJr2H1S29mBgufD1',
      category: 'kader',
      color: 'border-rose-300 text-rose-700 bg-rose-50/50',
      badgeBg: 'bg-rose-500 text-white shadow-rose-100',
    },
    {
      ...
      role: 'Kader',
      name: 'Puspa Ningsih',
      imageUrl: 'https://drive.google.com/thumbnail?id=1d6ActG-hKcaiGXl4-_NzRXNkK1XoseZO',
      category: 'kader',
      color: 'border-rose-300 text-rose-700 bg-rose-50/50',
      badgeBg: 'bg-rose-500 text-white shadow-rose-100',
    },
    {
      ...
      role: 'Kader',
      name: 'Sanni Noviati',
      imageUrl: 'https://drive.google.com/thumbnail?id=1ZL-751cgNN5Hxe4K7k6QZiVPeMXEG1Tz',
      category: 'kader',
      color: 'border-rose-300 text-rose-700 bg-rose-50/50',
      badgeBg: 'bg-rose-500 text-white shadow-rose-100',
    },
    {
      ...
      role: 'Kader',
      name: 'Sri Astuti',
      imageUrl: 'https://drive.google.com/thumbnail?id=1GP6PBpAW3sCgs0ioy_Ouiz8OINpxJMV6',
      category: 'kader',
      color: 'border-rose-300 text-rose-700 bg-rose-50/50',
      badgeBg: 'bg-rose-500 text-white shadow-rose-100',
    },
    {
      ...
      role: 'Kader',
      name: 'Sri Nunung',
      imageUrl: 'https://drive.google.com/thumbnail?id=11VDogVPDNQ2jwuTAtqRgQvEfafeiLdO7',
      category: 'kader',
      color: 'border-rose-300 text-rose-700 bg-rose-50/50',
      badgeBg: 'bg-rose-500 text-white shadow-rose-100',
    },
    {
      ...
      role: 'Kader',
      name: 'Uum Sari',
      imageUrl: 'https://drive.google.com/thumbnail?id=15q8zdimFVRPZZdEly93vqk06tsX_HT14',
      category: 'kader',
      color: 'border-rose-300 text-rose-700 bg-rose-50/50',
      badgeBg: 'bg-rose-500 text-white shadow-rose-100',
    },
